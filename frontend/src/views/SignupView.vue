<template>
  <div class="min-h-screen bg-gradient-to-br from-macaroon-mint-50 via-macaroon-vanilla-50 to-macaroon-peach-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <!-- Navigation Header -->
    ...
    <div class="flex items-center justify-center p-4 min-h-[calc(100vh-4rem)]">
      <div class="w-full max-w-md">
        <div class="text-center mb-8">
          <h1 class="text-3xl font-bold bg-gradient-to-r from-macaroon-mint-500 to-macaroon-peach-500 bg-clip-text text-transparent mb-2">
            Join Sparklet
          </h1>
          <p class="text-gray-600 dark:text-gray-400">Start your job search journey today</p>
        </div>
      
      <form @submit.prevent="handleSignup" class="card">
      ...
      <div class="text-center mt-6">
        <p class="text-xs text-gray-500 dark:text-gray-400">
          ...
          <router-link to="/login" class="text-macaroon-peach-600 hover:text-macaroon-peach-700 font-medium">
            Sign in here
          </router-link>
        </p>
